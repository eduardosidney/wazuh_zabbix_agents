...
sed -i '117 s/'Server=127.0.0.1'/'Server=IPDESEJADO'/' /etc/zabbix/zabbix_agentd.conf
sed -i '170 s/'ServerActive=127.0.0.1'/'ServerActive=IPDESEJADO'/' /etc/zabbix/zabbix_agentd.conf
